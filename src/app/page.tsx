...
export default async function Home() {
    ...
    try {
        ...
        // UPPDATERAD: Använder BASE_URL istället för den tidigare localhost-fallbacken
        const response = await fetch(`${BASE_URL}/decks/api`, {
            cache: 'no-store',
        ...
        if (response.ok) {
            ...
            console.error("Dashboard fetch misslyckades:", response.status);
        }
    } catch (e) {
